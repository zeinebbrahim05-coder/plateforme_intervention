...
const{create,getClientInterventions,getTechnicienInterventions,updateInterventionStatus,getInterventionById,addRapport,getRapport,addEvaluation,getAllInterventions,affecterTechnicien,autoAffecter, getInterventionsByWeek,getIntereventionsByMonth}=require('../controllers/interventionController');
...
router.get('/semaine/:date', authenticate, authorize(['planificateur']), getInterventionsByWeek);
router.get('/mois/:annee/:mois',authenticate,authorize(['planificateur']),getIntereventionsByMonth);
